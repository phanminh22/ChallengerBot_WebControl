    ...
    public partial class PVPNetConnection
    {
        ...
        private bool GetAuthKey()
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    //ChallengerBot.Core.Status("Error connecting. Attempting to reconnect...", user);
                    Disconnect();
        ...
        public void Error(string message, ErrorType type)
        {
            Error(message, "", type);
        }
            ...
            decodeThread = new Thread(() =>
            {
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        if (result["result"].Equals("_error"))
                        {
                            Debug.WriteLine(result.GetTO("data")["faultString"]);
